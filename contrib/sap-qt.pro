...
RESOURCES += src/qt/sap.qrc src/qt/sap_locale.qrc

TRANSLATIONS += src/qt/locale/sap_bg.ts \
                src/qt/locale/sap_de.ts \
                src/qt/locale/sap_en.ts \
                src/qt/locale/sap_es.ts \
                src/qt/locale/sap_fi.ts \
                src/qt/locale/sap_fr.ts \
                src/qt/locale/sap_it.ts \
                src/qt/locale/sap_ja.ts \
                src/qt/locale/sap_pl.ts \
                src/qt/locale/sap_pt.ts \
                src/qt/locale/sap_ru.ts \
                src/qt/locale/sap_sk.ts \
                src/qt/locale/sap_sv.ts \
                src/qt/locale/sap_vi.ts \
                src/qt/locale/sap_zh_CN.ts \
                src/qt/locale/sap_zh_TW.ts
