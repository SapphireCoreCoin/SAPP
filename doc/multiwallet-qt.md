...
In order to support loading of multiple wallets in sap-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sap.cpp.
...
Changes to sap.cpp
----------------------
sap.cpp is the entry point into sap-qt, and as such, will require some minor modifications to provide hooks for
