...
Sapphire Core version *version* is now available from:  <https://github.com/SapphireCoreCoin/SAP/releases>
...
Sapphire Core is extensively tested on multiple operating systems using the Linux kernel, macOS 10.8+, and Windows 7 and later.
