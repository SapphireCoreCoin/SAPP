...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04eb1b04151492171d2d5f02d4338b5b11ba1df171d9fb220d4d08346592fbfb5be897b8353f4a2bafb9380402ba31ee2d20b073787a6dfcb1736fbbcb91620deb");
        nDefaultPort = 45328;
...
//        nSubsidyHalvingInterval = 210000;
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Sapphire: 1 day
        nTargetSpacing = 1 * 60;  // Sapphire: 1 minute
        nMaturity = 100;
        ...
        nZerocoinStartTime = 1808224600; // April 20, 2027 12:36:00 PM
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1556165178;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2894113;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000eef0583695d6da23a78bab1c39939bbb54cf9bd5f0d4881c8eef364cd26"));
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zsap to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("04ec1c39d8c39af985930a36fba7993a96d2ba398134f08884161e341e1b579f2b71a64e66db2fb27129db4c5ced98ef6108b2e60d9c6f1a9457051ee2067a8cf8");
        nDefaultPort = 45330;
...
//        assert(hashGenesisBlock == uint256("0x0000041e482b9b9691d98eefb48473405c0b8ec31b76df3797c74a78680ef818"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "sap-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "sap-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 140); // Testnet sap addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet sap script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet sap BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet sap BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet sap BIP44 coin type is '1' (All coin's testnet default)
        ...
        strSporkKey = "04af7a5f0d95e2974e0402ddeb3d8a6f832af2b0d61ae9db5149680d5cd827e3da16fb9f49b36dc4aee2112b644c631461fe1b11a16167477585937230cf7e8d1b";
        strSporkKeyOld = "04af7a5f0d95e2974e0402ddeb3d8a6f832af2b0d61ae9db5149680d5cd827e3da16fb9f49b36dc4aee2112b644c631461fe1b11a16167477585937230cf7e8d1b";
