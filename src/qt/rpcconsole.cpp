                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSAPPathCustom = GetArg("-zsapbackuppath", "");
    ...
    if(!strzSAPPathCustom.empty()) {
        ui->wallet_customzsapbackuppath->setText(QString::fromStdString(strzSAPPathCustom));
        ui->wallet_customzsapbackuppath_label->setVisible(true);
        ui->wallet_customzsapbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSAPPathCustom.empty()) && nCustomBackupThreshold > 0) {
