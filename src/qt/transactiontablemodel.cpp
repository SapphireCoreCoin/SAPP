...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeZSAP:
        return tr("zSAP Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted SAPP to zSAP");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zSAP");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received SAPP from zSAP");
    case TransactionRecord::ZerocoinSpend_Change_zSap:
        return tr("Minted Change as zSAP from zSAP Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zSAP to SAPP");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zSap:
        return tr("Anonymous (zSAP Transaction)");
    case TransactionRecord::StakeZSAP:
        return tr("Anonymous (zSAP Stake)");
    case TransactionRecord::SendToSelf:
    default:
...
QVariant TransactionTableModel::txStatusDecoration(const TransactionRecord* wtx) const
{
    ...
    case TransactionStatus::Immature: {
        ...
        int part = (wtx->status.depth * 5 / total) + 1; //fix to display missing clock5.png tx image
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::ForegroundRole:
        ...
        if (rec->type == TransactionRecord::Generated || rec->type == TransactionRecord::StakeMint ||
                rec->type == TransactionRecord::StakeZSAP || rec->type == TransactionRecord::MNReward) {
