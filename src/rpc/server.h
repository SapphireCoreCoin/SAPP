...
extern UniValue setzsapseed(const UniValue& params, bool fHelp);
extern UniValue getzsapseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzsap(const UniValue& params, bool fHelp);
extern UniValue dzsapstate(const UniValue& params, bool fHelp);
