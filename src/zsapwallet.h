...
#ifndef SAP_ZSAPWALLET_H
#define SAP_ZSAPWALLET_H
...
public:
    CzSAPWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSAP(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSAP(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
